...
_translations['JobScheduler is waiting for activation.']   = 'JobScheduler ждёт активизации.';
...
_translations['Resume order parametrized']                 = 'Ордер продолжить с параметрами';
_translations['Resume order $order']                       = 'Ордер продолжить $order';
