...
_translations['JobScheduler is waiting for activation.']   = 'JobScheduler est en attente de l\'activation.';
...
_translations['End (API job)']                             = 'Terminer (API tâche)';
_translations['Kill immediately']                          = 'Tuer immédiatement';
_translations['Terminate (UNIX)']                          = 'Arrêter (UNIX)';
_translations['Terminate with timeout (UNIX)']             = 'Arrêter avec le délai d\'attente (UNIX)';
...
_translations['Resume order parametrized']                 = 'Reprendre l\'ordre avec des paramètres';
_translations['Resume order $order']                       = 'Reprendre l\'ordre $order';
...
_translations['Priority']                                  = 'Priorité';
...
_translations['Default start time in the &quot;<i>Add order</i> &quot;-Dialog is <i>never</i>'] = 'Date de lancement par défaut pour &quot;<i>Ajouter un ordre</i>&#160;&quot; est <i>never</i>';
