...
public class AgentClusterMember extends AgentOfCluster {
    ...
    public AgentClusterMember(Long agentClusterId, String url, Date surveyDate, String version, Integer state, Date startedAt, String hostname,
            String osName, String osArchitecture, String osDistribution) {
