...
@XmlType(name = "")
@XmlRootElement(name = "remote_scheduler.remote_task.kill")
public class RemoteSchedulerRemoteTaskKill {
    ...
    /**
     * Ruft den Wert der signal-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Legt den Wert der signal-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
