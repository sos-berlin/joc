...
public class CalendarUsedByWriterTest {
    ...
    public void updateUsedByTest() throws Exception {
        String command = "<modify_order><run_time><weekdays><day day='1 2 3 4 5 6 7'><period single_start='00:01'/></day></weekdays><date date='2017-10-10' calendar_id='1'><period single_start='19:00:00'/></date><date date='2017-10-13' calendar_id='1'><period single_start='12:12:00'/></date><date date='2017-11-03' calendar_id='2'><period single_start='14:02:00'/></date> <holidays ><holiday  date='2017-10-09' calendar_id='3'/></holidays></run_time></modify_order>";
        CalendarUsedByWriter calendarUsedByWriter = new CalendarUsedByWriter(sosHibernateSession,1L,"JOB_CHAIN", "test,1", command);
        calendarUsedByWriter.updateUsedBy();
    }

    @Test
    public void deleteUsedByTest() throws Exception {
        CalendarUsedByWriter calendarUsedByWriter = new CalendarUsedByWriter(sosHibernateSession,1L,"JOB_CHAIN", "test,1", "");
