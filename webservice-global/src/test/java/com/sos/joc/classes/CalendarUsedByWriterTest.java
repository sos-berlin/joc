...
public class CalendarUsedByWriterTest {
    ...
    public void updateUsedByTest() throws Exception {
        ...
        CalendarUsedByWriter calendarUsedByWriter = new CalendarUsedByWriter(sosHibernateSession, TestEnvWebserviceGlobalsTest.SCHEDULER_ID, CalendarObjectType.ORDER,
                "test,1", command);
