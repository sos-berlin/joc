...
public class JobSchedulerResourceSupervisorPImplTest {
    ...
    public void postjobschedulerSupervisorPTest() throws Exception   {
        ...
        JobSchedulerPResponse jobschedulerResponse = jobschedulerResourceSupervisorPImpl.postJobschedulerSupervisorP(sosShiroCurrentUserAnswer.getAccessToken(), jobSchedulerDefaultBody);
