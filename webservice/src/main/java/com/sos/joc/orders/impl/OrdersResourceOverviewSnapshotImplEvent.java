...
@Path("orders")
public class OrdersResourceOverviewSnapshotImplEvent extends JOCResourceImpl
		implements IOrdersResourceOverviewSnapshotEvent {
	...
	@Override
	public JOCDefaultResponse postOrdersOverviewSnapshotEvent(String xAccessToken, String accessToken,
	...
	public JOCDefaultResponse postOrdersOverviewSnapshotEvent(String accessToken, JobChainsFilter jobChainsFilter)
			throws Exception {
		try {
