...
public class TreeResourceImpl extends JOCResourceImpl implements ITreeResource {
    ...
    // private void initJobSchedulerObjects(TreeView entity,
    // List<JobSchedulerObjectType> types, Set<String> folderSet, Boolean
    // compact)
    // throws Exception {
    ...
    // List<ProcessClassP> outputProcessClasses = new
    // ArrayList<ProcessClassP>();
    ...
    // InventoryJobsDBLayer jobsLayer = new
    // InventoryJobsDBLayer(Globals.sosHibernateConnection);
    // List<DBItemInventoryJob> jobsFromDb = new
    // ArrayList<DBItemInventoryJob>();
    // for (String folder : folderSet) {
    // List<DBItemInventoryJob> jobResults = null;
    // jobResults = jobsLayer.getInventoryJobsFilteredByFolder(folder, null,
    // true, dbItemInventoryInstance .getId());
    // if (jobResults != null && !jobResults.isEmpty()) {
    // jobsFromDb.addAll(jobResults);
    // }
    // }
    // for (DBItemInventoryJob jobFromDb : jobsFromDb) {
    // JobP job = JobPermanent.getJob(jobFromDb, jobsLayer, compact,
    ...
    // InventoryJobChainsDBLayer jobChainsLayer = new
    // InventoryJobChainsDBLayer(Globals.sosHibernateConnection);
    // List<DBItemInventoryJobChain> jobChainsFromDb = new
    // ArrayList<DBItemInventoryJobChain>();
    // for (String folder : folderSet) {
    // List<DBItemInventoryJobChain> jobChainResults = null;
    // jobChainResults = jobChainsLayer.getJobChainsByFolder(folder, true,
    // dbItemInventoryInstance.getId());
    ...
    // JobChainP jobChain = JobChainPermanent.initJobChainP(jobChainsLayer,
    // jobChainFromDb, compact, dbItemInventoryInstance.getId());
    // if (jobChain != null) {
    // outputJobChains.add(jobChain);
    // }
    // }
    // } else if (type.equals(JobSchedulerObjectType.ORDER)) {
    // InventoryOrdersDBLayer ordersLayer = new
    // InventoryOrdersDBLayer(Globals.sosHibernateConnection);
    // List<DBItemInventoryOrder> ordersFromDb = new
    // ArrayList<DBItemInventoryOrder>();
    // for (String folder : folderSet) {
    // List<DBItemInventoryOrder> orderResults = null;
    // orderResults = ordersLayer.getInventoryOrdersFilteredByFolders(folder,
    // true, dbItemInventoryInstance.getId());
    // if (orderResults != null && !orderResults.isEmpty()) {
    // ordersFromDb.addAll(orderResults);
    // }
    // }
    // outputOrders.addAll(OrderPermanent.fillOutputOrders(ordersFromDb,
    // ordersLayer, compact));
    // } else if (type.equals(JobSchedulerObjectType.PROCESSCLASS)) {
    // InventoryProcessClassesDBLayer pcLayer = new
    // InventoryProcessClassesDBLayer(Globals.sosHibernateConnection);
    // List<DBItemInventoryProcessClass> pcsFromDb = new
    // ArrayList<DBItemInventoryProcessClass>();
    // for (String folder : folderSet) {
    // List<DBItemInventoryProcessClass> pcResults = null;
    // pcResults = pcLayer.getProcessClassesByFolders(folder,
    // dbItemInventoryInstance.getId(), true);
    // if (pcResults != null && !pcResults.isEmpty()) {
    // pcsFromDb.addAll(pcResults);
    // }
    // }
    // outputProcessClasses =
    // ProcessClassPermanent.getProcessClassesList(pcLayer, pcsFromDb, null);
    // } else if (type.equals(JobSchedulerObjectType.SCHEDULE)) {
    // InventorySchedulesDBLayer schedulesLayer = new
    // InventorySchedulesDBLayer(Globals.sosHibernateConnection);
    // List<DBItemInventorySchedule> schedulesFromDb = new
    // ArrayList<DBItemInventorySchedule>();
    // for (String folder : folderSet) {
    // List<DBItemInventorySchedule> scheduleResults = null;
    // scheduleResults = schedulesLayer.getSchedulesByFolders(folder,
    // dbItemInventoryInstance.getId(), true);
    ...
    // ScheduleP schedule = SchedulePermanent.initSchedule(schedulesLayer,
    // scheduleFromDb, dbItemInventoryInstance);
    // if (schedule != null) {
    // outputSchedules.add(schedule);
    // }
    // }
    // } else if (type.equals(JobSchedulerObjectType.LOCK)) {
    // InventoryLocksDBLayer locksLayer = new
    // InventoryLocksDBLayer(Globals.sosHibernateConnection);
    // List<DBItemInventoryLock> locksFromDb = new
    // ArrayList<DBItemInventoryLock>();
    // for (String folder : folderSet) {
    // List<DBItemInventoryLock> lockResults = null;
    // lockResults = locksLayer.getLocksByFolders(folder,
    // dbItemInventoryInstance.getId(), true);
    // if (lockResults != null && !lockResults.isEmpty()) {
    // locksFromDb.addAll(lockResults);
    // }
    // }
    // outputLocks.addAll(LockPermanent.getListOfLocksToAdd(locksLayer,
    // locksFromDb, null));
    // }
    // }
