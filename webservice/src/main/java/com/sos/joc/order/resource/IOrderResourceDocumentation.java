...
public interface IOrderResourceDocumentation {
    ...
    public JOCDefaultResponse assignDocu(@HeaderParam("X-Access-Token") String xAccessToken, OrderDocuFilter filter) throws Exception;

    @POST
    @Path("documentation/unassign")
    public JOCDefaultResponse unassignDocu(@HeaderParam("X-Access-Token") String xAccessToken, OrderDocuFilter filter) throws Exception;
