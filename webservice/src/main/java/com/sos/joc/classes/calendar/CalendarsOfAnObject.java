...
public class CalendarsOfAnObject {
    ...
    public static Calendars get(SOSHibernateSession connection, Long instanceId, CalendarType type, String path, Boolean compact)
        ...
        List<DBItemCalendar> dbCalendars = dbCalendarLayer.getCalendarsOfAnObject(instanceId, type.name(), path);
