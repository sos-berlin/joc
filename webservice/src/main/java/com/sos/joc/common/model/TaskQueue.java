...
public class TaskQueue {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(id).append(enqueued).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(id, rhs.id).append(enqueued, rhs.enqueued).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
