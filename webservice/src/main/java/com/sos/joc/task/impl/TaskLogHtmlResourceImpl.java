...
public class TaskLogHtmlResourceImpl extends JOCResourceImpl implements ITaskLogHtmlResource {
	...
	@Override
	public JOCDefaultResponse getTaskLogHtml(String xAccessToken, String accessToken, String queryAccessToken,
			String jobschedulerId, String taskId) throws Exception {
		return getTaskLogHtml(getAccessToken(xAccessToken, accessToken), queryAccessToken, jobschedulerId, taskId);
	}

	public JOCDefaultResponse getTaskLogHtml(String accessToken, String queryAccessToken, String jobschedulerId,
		...
		try {
			...
			JOCDefaultResponse jocDefaultResponse = init(API_CALL, taskFilter, accessToken, jobschedulerId,
					getPermissonsJocCockpit(taskFilter.getJobschedulerId(), accessToken).getJob().getView()
							.isTaskLog());
			...
			return JOCDefaultResponse.responseHtmlStatus200(
					logTaskContent.htmlPageWithColouredLogContent(log, "Task " + taskFilter.getTaskId()));
