...
public class TaskResourceImpl extends JOCResourceImpl implements ITaskResource {
	...
	public JOCDefaultResponse postTask(String accessToken, TaskFilter taskFilter) throws Exception {
		try {
			...
			task.setEnqueued(JobSchedulerDate
					.getDateFromISO8601String(jocXmlCommand.getAttributeValue(taskElem, "enqueued", null)));
			...
			task.setIdleSince(JobSchedulerDate
					.getDateFromISO8601String(jocXmlCommand.getAttributeValue(taskElem, "idle_since", null)));
			task.setInProcessSince(JobSchedulerDate
					.getDateFromISO8601String(jocXmlCommand.getAttributeValue(taskElem, "in_process_since", null)));
			task.setStartedAt(JobSchedulerDate
					.getDateFromISO8601String(jocXmlCommand.getAttributeValue(taskElem, "running_since", null)));
			task.setPlannedStart(JobSchedulerDate
					.getDateFromISO8601String(jocXmlCommand.getAttributeValue(taskElem, "start_at", null)));
