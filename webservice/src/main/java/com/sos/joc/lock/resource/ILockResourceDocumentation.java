...
public interface ILockResourceDocumentation {
    ...
    public JOCDefaultResponse assignDocu(@HeaderParam("X-Access-Token") String xAccessToken, LockDocuFilter filter) throws Exception;

    @POST
    @Path("documentation/unassign")
    public JOCDefaultResponse unassignDocu(@HeaderParam("X-Access-Token") String xAccessToken, LockDocuFilter filter) throws Exception;
