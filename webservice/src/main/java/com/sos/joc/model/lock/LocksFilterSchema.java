...
public class LocksFilterSchema {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(jobschedulerId).append(locks).append(regex).append(folders).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(jobschedulerId, rhs.jobschedulerId).append(locks, rhs.locks).append(regex, rhs.regex).append(folders, rhs.folders).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
