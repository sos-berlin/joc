...
public class LocksVSchema {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(deliveryDate).append(locks).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(deliveryDate, rhs.deliveryDate).append(locks, rhs.locks).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
