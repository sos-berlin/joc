...
public class ModifyNodeSchema {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(jobschedulerId).append(nodes).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(jobschedulerId, rhs.jobschedulerId).append(nodes, rhs.nodes).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
