...
public class HolidayCalendar {
    ...
    @JsonProperty("view")
    private View_____________ view;
    @JsonIgnore
     ...
     */
    @JsonProperty("view")
    public View_____________ getView() {
        return view;
    }
     ...
     */
    @JsonProperty("view")
    public void setView(View_____________ view) {
        this.view = view;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HolidayCalendar) == false) {
            return false;
        }
        HolidayCalendar rhs = ((HolidayCalendar) other);
