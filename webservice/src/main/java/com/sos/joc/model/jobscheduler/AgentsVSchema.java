...
public class AgentsVSchema {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(deliveryDate).append(agents).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(deliveryDate, rhs.deliveryDate).append(agents, rhs.agents).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
