...
public class EventAction {
     ...
     */
    @JsonProperty("view")
    public View____________ getView() {
        return view;
    }
     ...
     */
    @JsonProperty("view")
    public void setView(View____________ view) {
        this.view = view;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EventAction) == false) {
            return false;
        }
        EventAction rhs = ((EventAction) other);
