...
public class SummarySchema {
     ...
     */
    @JsonProperty("orders")
    public void setOrders(Orders_ orders) {
        this.orders = orders;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SummarySchema) == false) {
            return false;
        }
        SummarySchema rhs = ((SummarySchema) other);
