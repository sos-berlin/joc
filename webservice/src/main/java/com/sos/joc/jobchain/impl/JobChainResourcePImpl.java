...
public class JobChainResourcePImpl extends JOCResourceImpl implements IJobChainResourceP {
    ...
    public JOCDefaultResponse postJobChainP(String accessToken, JobChainFilterSchema jobChainFilterSchema) throws Exception {
        ...
        try {
           ...
           // InventoryJobsDBLayer dbLayer = new InventoryJobsDBLayer(Globals.sosHibernateConnection, jobChainFilterSchema.getJobschedulerId());
           // DBItemInventoryJobChain inventoryJobChain = dbLayer.getInventoryJobChainByName(jobChainFilterSchema.getJobChain());
