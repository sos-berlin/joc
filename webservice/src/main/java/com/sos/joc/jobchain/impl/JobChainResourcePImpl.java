...
public class JobChainResourcePImpl extends JOCResourceImpl implements IJobChainResourceP {
    ...
    @Override
    public JOCDefaultResponse postJobChainP(String xAccessToken, String accessToken, JobChainFilter jobChainFilter) throws Exception {
    ...
    public JOCDefaultResponse postJobChainP(String accessToken, JobChainFilter jobChainFilter) {
        ...
        try {
            ...
            String documentation = dbDocLayer.getDocumentationPath(jobChainFilter.getJobschedulerId(), JobSchedulerObjectType.JOBCHAIN,
                    inventoryJobChain.getName());
            JobChainP jobChain = JobChainPermanent.initJobChainP(dbLayer, inventoryJobChain, documentation, processClassJobs, jobChainFilter
                    .getCompact(), instanceId);
            if (jobChain != null) {
                ...
                if (!JobChainPermanent.NESTED_JOB_CHAIN_NAMES.isEmpty()) {
                    ...
                    for (String nestedJobChainName : JobChainPermanent.NESTED_JOB_CHAIN_NAMES) {
                        ...
                        if (nestedJobChain != null) {
                            JobChainP nestedJobChainP = JobChainPermanent.initJobChainP(dbLayer, nestedJobChain, documentation, processClassJobs,
