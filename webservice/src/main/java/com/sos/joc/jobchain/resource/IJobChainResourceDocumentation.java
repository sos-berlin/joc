...
public interface IJobChainResourceDocumentation {
    ...
    public JOCDefaultResponse assignDocu(@HeaderParam("X-Access-Token") String xAccessToken, JobChainDocuFilter filter) throws Exception;

    @POST
    @Path("documentation/unassign")
    public JOCDefaultResponse unassignDocu(@HeaderParam("X-Access-Token") String xAccessToken, JobChainDocuFilter filter) throws Exception;
