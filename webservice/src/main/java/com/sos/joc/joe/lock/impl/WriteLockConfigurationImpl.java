...
public class WriteLockConfigurationImpl extends JOCResourceImpl implements IWriteLockConfigurationResource {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(WriteLockConfigurationImpl.class);
    private static final String API_CALL = "./joe/configuration/writeLocks";

    @Override
    public JOCDefaultResponse writeLocks(String accessToken, Lock lock) throws Exception {
        try {
