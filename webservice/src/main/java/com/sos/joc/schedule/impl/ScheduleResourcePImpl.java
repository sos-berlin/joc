...
public class ScheduleResourcePImpl extends JOCResourceImpl implements IScheduleResourceP {
	...
	@Override
	public JOCDefaultResponse postScheduleP(String xAccessToken, String accessToken, ScheduleFilter scheduleFilter)
			throws Exception {
		...
		try {
			...
			if (scheduleFromDb == null) {
				throw new DBMissingDataException(
						String.format("no schedule found in DB: %s", scheduleFilter.getSchedule()));
			}
